...
import json
from yt_s_con.pipeline.steps.step import Step
from yt_s_con.settings import API_KEY


class GetVideoList(Step):  # 命名class不用底線
    ...
    def write_to_file(selfself, video_links, filepath):
